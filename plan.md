...
- **Hosting**: Veröffentlichung der App über GitHub Pages.

## 2. Technische Architektur
Da die App schnell, wartungsarm und einfach auf GitHub Pages hostbar sein soll, setzen wir auf eine reine **Client-Side-Anwendung (HTML/CSS/JS)** ohne Backend-Server:
...
2. **Freigabe-Rückfrage**: Bevor Änderungen per Git in das GitHub-Repository übertragen und veröffentlicht werden, fragen wir den Benutzer explizit um Erlaubnis.
3. **Push & Deployment**: Nach Zustimmung erfolgt der Push auf `main` und die Aktivierung von GitHub Pages.
